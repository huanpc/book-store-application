...
LOCK TABLES `hoa_hong` WRITE;
/*!40000 ALTER TABLE `hoa_hong` DISABLE KEYS */;
INSERT INTO `hoa_hong` VALUES ('0',5000000,1),('1',10000000,2),('2',14000000,3),('3',16000000,4);
/*!40000 ALTER TABLE `hoa_hong` ENABLE KEYS */;
UNLOCK TABLES;
