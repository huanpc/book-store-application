...
CREATE TABLE `vip` (
  `idvip` varchar(10) COLLATE utf8_unicode_ci NOT NULL,
  `tichdiem` int(11) DEFAULT NULL,
  `giamgia` int(3) DEFAULT NULL,
  PRIMARY KEY (`idvip`)
...
INSERT INTO `vip` VALUES ('0',0,0),('1',5000000,2),('2',10000000,4),('3',15000000,6),('4',20000000,7);
